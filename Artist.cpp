...
std::vector<SDL_Texture*> Artist::loadAnimationData(std::string textureFolderLocation, std::string textureSetName, int textureSetNumber, int textureAmount)
{
	Artist artist;
